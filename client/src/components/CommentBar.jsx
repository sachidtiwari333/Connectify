  ...
  return (
    <div>
      <div className="flex flex-col rounded-2xl justify-center items-center border-2 border-gray-400 p-5 max-w-180 gap-3  md:w-full w-90">
        ...
        <img
          src="https://media.gettyimages.com/id/1124485411/vector/mental-power-concept.jpg?s=612x612&w=0&k=20&c=x71PJ7QUUplpmGCr1TM7Ogr2IkPJl-7twDuGZBNIgbc="
        ...
        <div>
          <button className="flex items-center justify-between w-full mt-5">
            <div className="flex gap-3">
